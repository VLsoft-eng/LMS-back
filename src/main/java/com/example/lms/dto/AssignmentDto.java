...
@Schema(description = "Задание (краткое представление для списка)")
public record AssignmentDto(
        ...
        @Schema(description = "Статус ответа текущего студента. null — для OWNER/TEACHER или если ответ не сдан.", example = "NOT_SUBMITTED", nullable = true,
